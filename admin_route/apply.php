...
<STRONG>
   <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div id="page-wrapper">
            ...
            <div class="row-blue">
            <b style="color:#fff; font-size:25px;"> <center>JOBS</center></b>
            <div class="row">
                <div class="col-lg-12">
                                ...
                                <div class="panel panel-inverse " style="background-color:#46b8da">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseone" style="color:#fff"> <b> Available Jobs </b></a>
                                        </h4>
                                    </div>
                                ...
                                <table class="table table-striped" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php  
                                            ...
                                            $emp=(" select * from jobs") or die(mysql_error());
                                            $fetch_res = $mysqli->query($emp);
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <div class="col-lg-2">
                                              ...
                                              <button class="btn btn-outline btn-warning" data-toggle="modal" data-target="#apply">
                                Apply
                            </button>
 ...
 <div class="modal fade" id="apply" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form enctype="multipart/form-data"  action="applyjob.php" method="POST">


                                                   
                                                <input type="hidden" name="employee_id" class="form-control input-sm" value="<?php echo $employee_id;?>" />
                                        ...
                                        <input type="text" name="job_code" class="form-control input-sm"  required/>
                                            </div>
                                           <div class="input-group input-sm">
