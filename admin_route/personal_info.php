            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                 ...
                 <li>
                  ...
                  <!--<li>
                        <a  href="department.php" class="not_active"> <button type="button" class="btn btn-info btn-circle "><i class="fa fa-table fa-fw fa-lg"></i> </button>
						<b>Departments</b>
						 </a>
                 ...
                 <li>
                        <a  href="position.php" class="not_active"> <button type="button" class="btn btn-info btn-circle "><i class="fa fa-table fa-fw fa-lg"></i> </button>
						<b>Positions</b>
						 </a>
                  ...
                  <li>
                        <a  href="terminate.php" class="not_active"> <button type="button" class="btn btn-info btn-circle "><i class="fa fa-table fa-fw fa-lg"></i> </button>
